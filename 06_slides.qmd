...
- Gravity models jointly identify the cost sensitivity and fixed effects

-  If cost is misspecified --and it will be-- misspecification partially absorbed by fixed effects 
...
-   to **cleanly identify** how well each friction rationalizes the observed flows
...
-   Equilibrium employment levels are taken as given; we model the mobility flows conditional on those levels.
...
## Which distance metric best rationalizes the data? {.smaller}
