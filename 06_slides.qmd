...
dest_plt <- noc_specificity|>
  ...
  labs(fill="Hypothesized Type of Movement \n and (appropriate cost matrix)")
```
...
and too little weight elsewhere: "false negatives" are heavily penalized by KL.
- The binary cost matrix is more agnostic regarding moves, makes fewer false negative mistakes at low temperatures.

:::

## Hypothesized market segments

- It seems plausible that the 3 cost matrices might "win" in different parts of the labour market. e.g.

- Binary costs best rationalize the (lack of) mobility when 2016 occupation TEER 1 and education path is very tight. (e.g. Dentists)
- Skill cost best rationalize mobility when 2016 occupation TEER 0 or 5 or education path is very diffuse. (Managers, Labourers)
- Hierarchical cost best rationalizes mobility elsewhere.


## Education Path Specificity.
