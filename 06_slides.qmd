...
-   **Skill similarity**\
    Distance based on O\*NET skills, abilities, knowledge, work activities (U.S. occupational descriptors)
...
-   **Non-local mobility:** new educational attainment enables long distance "jumps"\
:::
...
-   Labour shortages in different segments likely require different adjustment mechanisms
    ...
    -   Medium gating: increasing supply of "first rung" workers (career ladders)
